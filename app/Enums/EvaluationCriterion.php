...
enum EvaluationCriterion: string implements HasColor, HasDescription, HasLabel
{
    ...
    public function getDescription(): string
    {
        return match ($this) {
            ...
            self::C8_Environment => 'Place du sport dans la vie privée, hygiène de vie (sommeil, récupération, gestion des excès, plans donnés hors entraînement, régulation des activités le week-end) et qualité de l\'environnement familial (soutien des parents sans omniprésence étouffante, suivi médical, adhésion à la philosophie du club).',
    ...
    public static function qualitativeRubric(): array
    {
        return [
            ...
            3 => [
                ...
                'description' => 'Niveau fragile et discontinu. Début de conformité encore instable, ne tient pas face à la difficulté.',
            ...
            5 => [
                'score' => 5,
                'tier' => 'acquis',
                'tier_label' => 'Standard / Acquis',
                'label' => 'Acquis • Standard du Club',
                'color' => 'blue',
                'badge_class' => 'bg-blue-100 text-blue-800 border-blue-300 ring-2 ring-blue-500/20 font-bold',
                'description' => 'CE QUI EST DEMANDÉ. Correspond au standard de conformité attendu. Répond pleinement, correctement et fidèlement aux exigences habituelles.',
    ...
    public static function qualitativeTiers(): array
    {
        return [
            'non_acquis' => [
                ...
                'scores' => [0, 1, 2],
                'name' => 'Non acquis',
                'subtitle' => 'En deçà des attentes',
                'badge_color' => 'bg-red-100 text-red-800 border-red-200',
                'border_color' => 'border-red-200',
                'bg_color' => 'bg-red-50/50',
                'text_color' => 'text-red-700',
                'highlight' => false,
                'summary' => 'Défaillance marquée ou absence des attendus minimaux fixés.',
            ],
            'en_cours' => [
                'range' => '3 à 4',
                'scores' => [3, 4],
                'name' => 'En cours d\'acquisition',
                'subtitle' => 'Fragile et irrégulier',
                ...
                'highlight' => false,
                'summary' => 'Acquisition fragile ou discontinue, en deçà du niveau attendu.',
            ],
            'acquis' => [
                'range' => '5 à 6',
                'scores' => [5, 6],
                'name' => 'Acquis',
                'subtitle' => 'Cadre minimal',
                ...
                'highlight' => true,
                'summary' => 'Ce qui est demandé. Répond précisément et avec constance aux attentes.',
            ],
            'maitrise' => [
                'range' => '7 à 8',
                'scores' => [7, 8],
                ...
                'highlight' => false,
                'summary' => 'Solide et régulier dépassement des exigences minimales avec proactivité.',
            ],
            'exceptionnel' => [
                'range' => '9 à 10',
                'scores' => [9, 10],
                'name' => 'Exceptionnel',
                'subtitle' => 'Excellence rare et modèle',
                ...
                'highlight' => false,
                'summary' => 'Excellence rare et remarquable, référence servant d\'exemple.',
            ],
        ];
    }
